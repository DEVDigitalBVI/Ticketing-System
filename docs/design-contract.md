...
| Authentication           | Implemented                                     | Supabase Auth sessions, domain user mapping, initial-password replacement, MFA-gated user administration, route protection, and server authorization are implemented. Account recovery remains unimplemented.         |

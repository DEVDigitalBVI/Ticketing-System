...
export function reportToCsv(report: ManagerReport) {
  const rows: Array<Array<string | number | null>> = [
    ...
    [
      "First response",
      "Created tickets",
      report.cards.averageFirstResponseMinutes,
      "support minutes",
    ],
    [
      "Resolution time",
      "Resolved tickets",
      report.cards.averageResolutionMinutes,
      "support minutes",
    ],
    [
      "Response SLA attainment",
      "Eligible created tickets",
      report.cards.responseSlaPercent,
      "percent",
    ],
    [
      "Resolution SLA attainment",
      "Eligible resolved tickets",
      report.cards.resolutionSlaPercent,
      "percent",
    ],
    ...
    [
      ...
      "Created tickets",
      report.cards.averageRequesterWaitingHours,
      "hours",
    ],
